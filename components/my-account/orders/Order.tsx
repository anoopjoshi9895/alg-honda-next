...
import { api, UserOrder } from "alg-ecom-frontend-core";
...
const Order: React.FunctionComponent<any> = (props) => {
  ...
  const {
    ...
    loaded,
    loading,
  } = useDataLoader<UserOrder[]>(() => api.user.gerOrders());
    ...
    <div className="px-lg-4 px-3 pb-3 pt-lg-3">
      <div className="dashboard-head d-lg-block d-none">
        <div className="row gutter-10 align-items-xl-center justify-content-end">
          <div className="col">
            <h5 className="m-0 text-uppercase">{t("dashboard.Order")}</h5>
          </div>
