...
const OrderDetails: React.FunctionComponent<CustomProps> = (props) => {
  const { t } = useTranslation();
  const { data: orderDetails, loading } = useDataLoader<UserOrderDetails>(() =>
    api.user.gerOrderDetails(props.orderId)
  );
          ...
          <div className="col-xl-auto">
            ...
            >
              <span className="py-1 d-block">
                {t("dashboard.Upload Finance LPO")}
              </span>
            </a>
            <a
              href=""
      ...
      <div className="border rounded px-3 py-4 mt-4">
        <div className="px-lg-1 line-height-normal">
            ...
            <div className="row gutter-12 pt-3 pb-5 align-items-center">
              ...
              <div className="col-md-auto col-sm-6 col-12">
                ...
                >
                  ...
                  {t("dashboard.Download Order Confimation")}
                </a>
                <a
                  href=""
                  className="d-flex align-items-center font-normal py-1"
          ...
          <div className="border-bottom py-4">
            <div className="row gutter-12 py-2 align-items-center">
              <div className="col-md-8 col-12 mb-md-0 mb-4">
                <h6 className="font-lg font-weight-normal mb-2">To</h6>
                <div className="font-md mb-1">
                  {orderDetails?.userFirstName} {orderDetails?.userLastName}
                </div>
                {/* <div className="font-normal text-muted mb-2 line-height">
                  ...
                  <div className="col-4 text-right">
                    {orderDetails?.accessoriesInfo.map((acc) => {
                      return (
                        <div
                          className="font-normal text-uppercase"
                          key={"price-info" + acc.productTitle}
                        >
                  ...
                  {orderDetails?.coupons.map((coupon) => {
                    ...
                    return (
                      <div
                        className="font-normal text-uppercase"
                        key={
                          "amt" + campaign?.couponCashBack?.couponCashbackTitle
                        }
                      >
            ...
            <div className="col-xl-5 col-sm-6 col-12 mb-4">
              <div className="bg-gray-200 p-3">
                <div className="row font-normal align-items-end py-1">
                  ...
                  {/* <div className="col-7 mb-2 pb-1">Cash Discount</div>
                  <div className="col-5 mb-2 text-right pb-1">-KD 60</div>
                  <div className="col-7 mb-2 pb-1">Ramadan offer</div>
                  <div className="col-5 mb-2 text-right pb-1">-KD 1000</div> */}
                </div>
          ...
          {orderDetails?.paidAmount > 0 && (
            <div>
              {/* <h6 className="font-xxl mb-3">Payment Receipt</h6>
              <div className="border-bottom py-2 mb-2">
                ...
                <div className="row gutter-12 align-items-end py-1 mb-1">
                  ...
                  <div className="col-4 text-right">
                    <div className="font-sm text-uppercase">KD 12,999</div>
                  </div>
                </div>
                <div className="row gutter-12 align-items-end py-1 mb-1">
                  <div className="col-8">
              ...
              {/* <div className="border-bottom py-2 mb-2">
                <h6 className="font-sm pb-1">Trade-In</h6>
                <div className="row gutter-12 align-items-end py-1 mb-1">
                  <div className="col-8">
                    <div className="font-sm text-muted">SPARK 2020</div>
                  </div>
                  <div className="col-4 text-right">
                    <div className="font-sm text-uppercase">KD 2500</div>
                  </div>
                </div>
              </div> */}
              {orderDetails?.financeDetails?.length > 0 && (
                <div className="border-bottom py-2 mb-2">
                  ...
                  <div className="row gutter-12 align-items-end py-1 mb-1">
                    <div className="col-8">
                      {orderDetails?.financeDetails.map((bnk) => {
                        return (
                          <>
                            <div
