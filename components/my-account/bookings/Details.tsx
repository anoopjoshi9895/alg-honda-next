...
const OrderDetails: React.FunctionComponent<CustomProps> = (props) => {
  ...
  const { data: orderDetails, loading } = useDataLoader<UserOrderDetails>(() =>
    api.user.getBookingDetails(props.orderId)
  );
        ...
        <div className="px-lg-1 line-height-normal">
          ...
          <div className="border-bottom py-2 mb-2">
            <div className="row gutter-12 align-items-end mb-1">
              ...
              <div className="col-4 text-right">
                {/* <div className="font-normal text-uppercase">KD 0</div> */}
              </div>
            </div>
          </div>
          <div className="border-bottom py-2 mb-2">
              ...
              <div className="border-bottom py-2 mb-2">
                <div className="row gutter-12 align-items-end mb-1">
                  <div className="col-8">
                    ...
                    {orderDetails?.accessoryPackages.map((acc, index) => {
                      return (
                        <div
            ...
            <div className="border-bottom py-2 mb-2">
              <div className="row gutter-12 align-items-end mb-2">
                <div className="col-8 mb-2">
                  ...
                  {orderDetails?.insuranceDetails.map((insu, index) => {
                    return (
                      <div key={`ins-${index}`}>
                        <div className="font-normal mb-1">
                ...
                {!!insuranceAddOns?.length && (
                  <>
                    ...
                    {insuranceAddOns?.map((add: any, index) => {
                      const insAddOn =
                        orderDetails?.insuranceDetails?.[0]?.planDetails?.addons?.find(
                          (x: any) =>
                      ...
                      return (
                        <>
                          <div className="col-8 mb-2" key={`ins-add-${index}`}>
                            <div className="font-normal text-muted mb-2">
                              {add?.addonName}
                            </div>
                          </div>
            ...
            <div className="border-bottom py-2 mb-2">
              <div className="row gutter-12 align-items-end mb-1">
                <div className="col-8">
                  ...
                  {orderDetails?.coupons.map((coupon, index) => {
            ...
            <div className="border-bottom py-2 mb-2">
              <div className="row gutter-12 align-items-end mb-1">
                <div className="col-12">
                  ...
                  {orderDetails?.vouchers.map((voucher, index) => {
                    return (
                      <div
                        className="font-normal text-muted mb-2"
                        key={`voc-${index}`}
          ...
          {orderDetails?.paidAmount > 0 && (
            <div>
              ...
              {/* <div className="border-bottom py-2 mb-2">
                <h6 className="font-sm pb-1">{t('dashboard.Trade-In')}</h6>
                <div className="row gutter-12 align-items-end py-1 mb-1">
                  <div className="col-8">
                        ...
                        return (
                          <>
                            <div
                              ...
                              key={`ord-fin-${index}`}
                            >
                              {t("dashboard.Bank")}: {bnk.bankName} - EMI KD{" "}
