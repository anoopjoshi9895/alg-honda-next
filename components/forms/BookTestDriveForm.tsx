...
import { QuickAccessFormProps } from '../../components/quick-access/utils';
...
const locations = [
  { showRoom: 'showRoom 1', value: 1 },
  { showRoom: 'showRoom 2', value: 2 },
  { showRoom: 'showRoom 3', value: 3 },
  { showRoom: 'showRoom 4', value: 4 },
];
const BookTestDriveForm: React.FunctionComponent<{
  ...
  // const productMedia = props.cartData?.productInfo?.combinationInfo[0]?.combinationMedia.find(
  //   (item) =>
...
export default connect(mapStateToProps, mapActionsToProps)(BookTestDriveForm);
