...
import { QuickAccessFormProps, TabNames } from '../../components/build-vehicle/utils';
import {
  ShowRoomModelBV,
  ProductViewModelBV,
  CartStateModel,
...
const RequestQuoteForm: React.FunctionComponent<{
...
export default connect(mapStateToProps, mapActionsToProps)(RequestQuoteForm);
