...
const SignUpOTPForm: React.FunctionComponent<{
  ...
  return (
    <>
      ...
      />
      {errors.otp && <span className="message-validation">Enter OTP</span>}
...
export default connect(mapStateToProps, mapActionsToProps)(SignUpOTPForm);
