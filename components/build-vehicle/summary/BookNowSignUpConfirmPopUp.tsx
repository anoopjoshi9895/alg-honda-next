...
import UserConfirmForm from "../../auth/UserConfirmForm";
...
const BookNowSignUpConfirmPopUp: React.FunctionComponent<CustomProps> = (
  props: CustomProps
) => {
        ...
        <div className="row mx-0">
          ...
          <div className="col-lg-7 col-12 p-lg-5 p-sm-4 p-3">
            <div className="book-form">
              ...
              <UserConfirmForm onSubmit={(data: any) => props.onSubmit(data)} />
            </div>
          </div>
        </div>
      </div>
